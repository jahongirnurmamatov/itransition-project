...
export default function Contact() {
  return (
    <div className="bg-transparent text-gray-300 py-8 px-4 md:px-6 lg:px-8">
      <div className="container mx-auto -mt-8 px-4 md:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="hidden md:flex space-y-4  flex-col  items-start justify-start "> 
